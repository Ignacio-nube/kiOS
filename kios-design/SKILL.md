---
name: kios-design
description: Design system de kiOS (POS para kioscos argentinos). Leer SIEMPRE antes de crear o modificar UI en la app (apps/app) o en la landing (apps/landing) — define tokens, componentes, reglas de color/tipografía y patrones de pantalla.
---
