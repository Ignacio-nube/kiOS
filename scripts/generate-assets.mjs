...
// Favicons raster + apple-touch por app. `size` en px; `apple` marca 180x180.
const RASTER_TARGETS = [
  { dir: "apps/app/public", sizes: [16, 32, 48, 180] },
  { dir: "apps/landing/public", sizes: [16, 32, 48, 180] },
];
...
async function main() {
  ...
  console.log("· SVG copiado a app y landing (%d destinos)", SVG_COPIES.length);
