...
/** Demo web (build de apps/app desplegado). */
export const DEMO_URL = import.meta.env.VITE_DEMO_URL as string | undefined;
...
export const SUPPORT_EMAIL =
  (import.meta.env.VITE_SUPPORT_EMAIL as string | undefined) ?? "hola@kios.com.ar";
